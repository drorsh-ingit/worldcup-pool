...
export const GOLDEN_BALL_CANDIDATES = [
  { playerName: "Harry Kane", teamCode: "ENG", odds: 800 },
  { playerName: "Lamine Yamal", teamCode: "ESP", odds: 900 },
  { playerName: "Michael Olise", teamCode: "FRA", odds: 1100 },
  { playerName: "Kylian Mbappé", teamCode: "FRA", odds: 1100 },
  { playerName: "Vinicius Jr.", teamCode: "BRA", odds: 1500 },
  { playerName: "Lionel Messi", teamCode: "ARG", odds: 1500 },
  { playerName: "Bruno Fernandes", teamCode: "POR", odds: 2100 },
  { playerName: "Rayan Cherki", teamCode: "FRA", odds: 2100 },
  { playerName: "Jude Bellingham", teamCode: "ENG", odds: 2600 },
  { playerName: "Vitinha", teamCode: "POR", odds: 2600 },
  { playerName: "Declan Rice", teamCode: "ENG", odds: 2600 },
  { playerName: "Pedri", teamCode: "ESP", odds: 2600 },
  { playerName: "Raphinha", teamCode: "BRA", odds: 2600 },
  { playerName: "Ousmane Dembélé", teamCode: "FRA", odds: 2600 },
  { playerName: "Rodri", teamCode: "ESP", odds: 2600 },
  { playerName: "Erling Haaland", teamCode: "NOR", odds: 2900 },
  { playerName: "Cristiano Ronaldo", teamCode: "POR", odds: 3400 },
  { playerName: "Bernardo Silva", teamCode: "POR", odds: 3400 },
  { playerName: "Julián Álvarez", teamCode: "ARG", odds: 4100 },
  { playerName: "Désiré Doué", teamCode: "FRA", odds: 4100 },
  { playerName: "Nico Williams", teamCode: "ESP", odds: 4100 },
  { playerName: "Jeremy Doku", teamCode: "BEL", odds: 5100 },
  { playerName: "Lautaro Martínez", teamCode: "ARG", odds: 5100 },
  { playerName: "Mikel Oyarzabal", teamCode: "ESP", odds: 5100 },
  { playerName: "Florian Wirtz", teamCode: "GER", odds: 5100 },
  { playerName: "Virgil van Dijk", teamCode: "NED", odds: 5100 },
  { playerName: "Fabián Ruiz", teamCode: "ESP", odds: 5100 },
] as const;

/** Best goalkeeper candidates (Golden Glove) — sourced from DraftKings odds (May 2026) */
export const GOLDEN_GLOVE_CANDIDATES = [
  { playerName: "Emiliano Martínez", teamCode: "ARG", odds: 550 },
  { playerName: "Unai Simón", teamCode: "ESP", odds: 550 },
  { playerName: "Alisson", teamCode: "BRA", odds: 600 },
  { playerName: "Mike Maignan", teamCode: "FRA", odds: 700 },
  { playerName: "Jordan Pickford", teamCode: "ENG", odds: 800 },
  { playerName: "Ederson", teamCode: "BRA", odds: 800 },
  { playerName: "David Raya", teamCode: "ESP", odds: 800 },
  { playerName: "Diogo Costa", teamCode: "POR", odds: 1100 },
  { playerName: "Oliver Baumann", teamCode: "GER", odds: 1300 },
  { playerName: "Joan García", teamCode: "ESP", odds: 1500 },
  { playerName: "Thibaut Courtois", teamCode: "BEL", odds: 2100 },
] as const;

/** Top scorer candidates — sourced from Betway market odds (Jun 2026) */
export const GOLDEN_BOOT_CANDIDATES = [
  { playerName: "Kylian Mbappé", teamCode: "FRA", odds: 600 },
  { playerName: "Harry Kane", teamCode: "ENG", odds: 750 },
  { playerName: "Lionel Messi", teamCode: "ARG", odds: 1300 },
  { playerName: "Mikel Oyarzabal", teamCode: "ESP", odds: 1500 },
  { playerName: "Erling Haaland", teamCode: "NOR", odds: 1500 },
  { playerName: "Lamine Yamal", teamCode: "ESP", odds: 1700 },
  { playerName: "Vinicius Jr.", teamCode: "BRA", odds: 2100 },
  { playerName: "Ousmane Dembélé", teamCode: "FRA", odds: 2100 },
  { playerName: "Cristiano Ronaldo", teamCode: "POR", odds: 2100 },
  { playerName: "Lautaro Martínez", teamCode: "ARG", odds: 2600 },
  { playerName: "Raphinha", teamCode: "BRA", odds: 2900 },
  { playerName: "Julián Álvarez", teamCode: "ARG", odds: 2900 },
  { playerName: "Kai Havertz", teamCode: "GER", odds: 2900 },
  { playerName: "Richarlison", teamCode: "BRA", odds: 3400 },
  { playerName: "Romelu Lukaku", teamCode: "BEL", odds: 3400 },
  { playerName: "Bukayo Saka", teamCode: "ENG", odds: 3600 },
  { playerName: "Estevão", teamCode: "BRA", odds: 3800 },
  { playerName: "Michael Olise", teamCode: "FRA", odds: 4100 },
  { playerName: "Cody Gakpo", teamCode: "NED", odds: 4100 },
  { playerName: "Luis Suárez", teamCode: "URU", odds: 4100 },
  { playerName: "Cole Palmer", teamCode: "ENG", odds: 4500 },
  { playerName: "Luis Díaz", teamCode: "COL", odds: 5100 },
  { playerName: "Memphis Depay", teamCode: "NED", odds: 5100 },
  { playerName: "Igor Thiago", teamCode: "BRA", odds: 4100 },
  { playerName: "Phil Foden", teamCode: "ENG", odds: 6700 },
  { playerName: "Niclas Füllkrug", teamCode: "GER", odds: 6700 },
] as const;
